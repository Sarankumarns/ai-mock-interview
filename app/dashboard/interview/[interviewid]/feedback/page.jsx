...
return (
    ...
    <h2 className='font-bold text-2xl '>No Interview  Record Found</h2>  
    :
        <>
...
<h2 className='text-3xl font-bold text-green-500'>Congratulations</h2>
      ...
      <h2 className='text-sm text-gray-900'>Find below interview question with correct answer,your answer and feedback for improvement</h2>
